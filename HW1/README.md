...
<br>
<br>
<img src="https://github.com/jiaying777/other/blob/master/區塊鏈圖/CryptoOctoCat.png" width=75% >
<br>
上課的時候買了2隻基本貓，並且生了一隻可愛的貓！！！
<br>
<br>
...
<br>
<br>
為了讓使用者在使用上更方便，IPSE 允許用戶爲hash地址添加語義標籤，通過 Hashlink 技術，使冗長難記的hash轉化爲簡單易懂的標題，
實現高效索引，快速搜索 IPFS 數據。IPSE 還建立了防作弊機制，防止惡意輸入數據，並有效消除冗餘數據。
對內容進行 hash 地址重複添加標籤的行爲，和短時間之內大量非正常挖礦的行爲，進行實時監控預警，有效防止作弊。
IPSE也是網際網路進入Web3.0時代，首個具有經濟價值的搜尋引擎。
<br>
<br>
IPSE能夠快速搜尋到你想要的東西，且不會像中心化的google壟斷資訊，並且收集使用者的個資及追蹤使用者，再將使用者個資販賣出去，
來達到精準投放廣告等等，IPSE介面簡潔，搜尋到的東西精準又不會有廣告，也不會追蹤使用者，不像使用google 時根本毫無隱私可言，
而且使用者的帳戶或資料完全不屬於自己，所以google 有權將你的資料全部刪掉，這對使用者來說是不安全的，
因此去中心化和加密是有意義的，可以保護使用者的隱私不被監視與利用，又可以確定資料是屬於使用者本人，沒有人可以竄改，讓使用者能夠更安心的使用。
<br>
<br>
<br>
